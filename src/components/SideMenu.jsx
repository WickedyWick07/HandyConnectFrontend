    ...
    return (
        <div className="w-44 min-h-full bg-white text-black">
            ...
            <h1 className="font-sans font-extrabold text-xl text-center p-2">HandyConnect</h1>
                <li><a href="/customer/dashboard" className=" py-2 px-4 rounded hover:bg-purple-500 hover:text-white flex items-center text-sm">
                    <img src={house} className='w-4 h-4 mr-2' />
                    Dashboard
                </a></li>
                <li><a href="/all-bookings" className=" py-2 px-4 rounded hover:bg-purple-500 hover:text-white flex items-center text-sm">
                    <img src={calendar} className='w-4 h-4 mr-2' />
                    My Bookings
                </a></li>
                <li><a href="/service-providers" className=" py-2 px-4 rounded hover:bg-purple-500 hover:text-white flex items-center text-sm">
                ...
                <li><a href="/history" className=" py-2 px-4 rounded hover:bg-purple-500 hover:text-white flex items-center text-sm">
